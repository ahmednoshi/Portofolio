...
export default function Port() {
  ...
  <div className='container  py-3  mx-auto mt-20 '>


<h1 className='font-black text-6xl text-white text-center py-16 '   id='Port'>
...
<a href="https://ahmednoshi.github.io/Pizza-Wep/" className='text-2xl font-black text-[#CCCCCC]'>
<h5 classname="mb-2 text-6xl font-black tracking-tight text-gray-100 dark:text-[#CCCCCC] ">Pizza<span className='text-blue-600 font-bold'>.</span>
</h5>
</a>
</div>
...
<h5 classname="mb-2 text-6xl font-black tracking-tight text-gray-100 dark:text-[#CCCCCC] ">Daniels<span className='text-blue-600 font-bold'>.</span>
</h5>
</a>
</div>
...
<div className='flex gap-2 justify-center items-center mt-8 ' >
<a href="https://ecommerce-freshcart-one.vercel.app/" className='text-2xl font-black text-[#CCCCCC]'>
<h5 classname="mb-2 text-6xl font-black tracking-tight text-gray-100 dark:text-[#CCCCCC] ">Ecommerce<span className='text-blue-600 font-bold'>.</span>
</h5>
</a>
</div>
...
<h5 classname="mb-2 text-6xl font-black tracking-tight text-gray-100 dark:text-[#CCCCCC] ">DevFolio<span className='text-blue-600 font-bold'>.</span>
</h5>
</a>
</div>
...
<h5 classname="mb-2 text-6xl font-black tracking-tight text-gray-100 dark:text-[#CCCCCC] ">Mealfiy<span className='text-blue-600 font-bold'>.</span>
</h5>
</a>
</div>
